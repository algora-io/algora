  ...
  def bounties(assigns) do
    ...
    <div class="-mt-2 -mx-2 relative overflow-auto">
      <table class="min-w-full divide-y divide-border">
        <thead>
          <tr>
            <th class="px-6 pl-2 py-2 text-left text-sm font-medium">Amount</th>
            <th class="px-6 py-2 text-left text-sm font-medium max-w-[300px]">Title</th>
            <th class="px-6 py-2 text-left text-sm font-medium">Issue</th>
            <th class="px-6 pr-2 py-2 text-right text-sm font-medium">Sponsors</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-border">
          <%= for ticket <- @tickets do %>
            <tr class="hover:bg-muted/50">
              <td class="px-6 pl-2 py-2 text-left">
