defmodule AlgoraWeb.Components.UI.Alert do
  @moduledoc false
  ...
  def alert(assigns) do
    ...
    <div
      class={
        classes([
          "[&>span~*]:pl-7 [&>span+div]:translate-y-[-3px] [&>span]:absolute [&>span]:left-4 [&>span]:top-4 relative w-full rounded-lg border p-4",
          @variant_class,
          @class
        ])
      }
