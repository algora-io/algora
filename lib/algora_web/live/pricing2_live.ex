defmodule AlgoraWeb.Pricing2Live do
  @moduledoc false
      ...
      <section class="bg-background pb-16 sm:pb-24">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="space-y-4">
            <%= for plan <- @plans do %>
              <div class={[
                "rounded-2xl bg-card/75 border p-8",
                plan.popular && "border-foreground-muted !border-2"
              ]}>
                <div class="flex flex-col lg:flex-row justify-between items-center gap-6">
                  <div class="flex-1">
                    <div class="flex items-center gap-2">
                      <h3 class="text-2xl font-display font-normal uppercase text-foreground">
                        {plan.name}
                      </h3>
                      <%= if plan.popular do %>
                      ...
                      <%= case plan.id do %>
                        <% 0 -> %>
                          <div class="flex items-baseline gap-4">
                            ...
                            <p class="text-sm text-muted-foreground">per transaction</p>
                          </div>
                        <% 1 -> %>
                          <div class="flex items-baseline gap-4">
                            <p class="text-4xl font-display text-foreground">$599</p>
                            <p class="text-sm text-muted-foreground">/mo + 9% per transaction</p>
                          </div>
                        <% 2 -> %>
                          <div class="flex items-baseline gap-4">
                            <p class="text-4xl font-display text-foreground">$1,590</p>
                            <p class="text-sm text-muted-foreground">/mo + 9% per transaction</p>
                          </div>
                      <% end %>
                    </div>
                  ...
                  <div class="flex-1 space-y-4">
                    <%= if plan.id > 0 do %>
                      <p class="text-sm text-foreground">
                        Everything in {Enum.at(@plans, plan.id - 1).name}, plus:
                      </p>
                    <% end %>
                    <ul class="text-xs grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <%= for feature <- plan.features do %>
                        <li class="flex items-center gap-2">
                          <.icon name="tabler-check" class="h-5 w-5 text-success" />
                          <span>{Phoenix.HTML.raw(feature.name)}</span>
                        </li>
                      <% end %>
                    </ul>
                  </div>
                  <div class="flex-none">
                    <.button navigate={plan.cta_url} variant="secondary">
                      {plan.cta_text}
                    </.button>
                  </div>
                </div>
        ...
        <div class="pt-4 mx-auto max-w-7xl px-6 lg:px-8">
  ...
  defp get_plans do
    [
      %Plan{
        ...
        description: "When you complete bounties & contracts",
        price: nil,
        cta_text: "Get started",
        cta_url: "/onboarding/dev",
        popular: false,
        features: [
          %Feature{name: "No platform fees"},
      ...
      %Plan{
        ...
        features: [
          ...
          %Feature{name: "Let your community sponsor you"}
        ]
      },
      %Plan{
        id: 1,
        ...
        features: [
          ...
          %Feature{name: "Custom branding & domain"},
          %Feature{name: "Priority support"},
          %Feature{name: "Automated payments"}
        ]
      },
      %Plan{
        id: 2,
        name: "Hire top %1 OSS engineers",
        ...
        features: [
          ...
          %Feature{name: "No placement fees (up to 5 jobs)"},
          %Feature{name: "Dedicated account manager"},
          %Feature{name: "Custom onboarding"},
          %Feature{name: "Volume discounts"}
        ]
      }
    ]
  end
