defmodule AlgoraWeb.Pricing3Live do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <div class="pt-24 xl:pt-20 2xl:pt-28">
      ...
      <section class="bg-background pb-16 sm:pb-24">
        ...
        <div class="mx-auto lg:max-w-[90rem] mt-16 mb-8">
          <div class="flex items-start gap-4">
            <div class="flex-1">
              <h2 class="text-2xl font-semibold text-foreground mb-2">
                <div class="flex items-center gap-2">
                  <.icon name="tabler-building-store" class="h-6 w-6 text-blue-400" /> Marketplace
                </div>
              </h2>
              <p class="text-base text-foreground-light">
        ...
        <div class="mx-auto grid gap-4 lg:max-w-[90rem] xl:grid-cols-3 xl:gap-0 border-l-4 border-blue-400">
          <%= for plan <- @plans2 do %>
